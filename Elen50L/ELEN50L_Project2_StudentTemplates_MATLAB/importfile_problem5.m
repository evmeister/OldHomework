function [freqmeas,Vgmeas5,Vomeas5] = importfile_problem5(workbookFile,sheetName,startRow,endRow)
%IMPORTFILE Import data from a spreadsheet
%   [freqmeas,Vgmeas5,Vomeas5] = IMPORTFILE(FILE) reads data from the first
%   worksheet in the Microsoft Excel spreadsheet file named FILE and
%   returns the data as column vectors.
%
%   [freqmeas,Vgmeas5,Vomeas5] = IMPORTFILE(FILE,SHEET) reads from the
%   specified worksheet.
%
%   [freqmeas,Vgmeas5,Vomeas5] = IMPORTFILE(FILE,SHEET,STARTROW,ENDROW)
...
%
% Example:
%   [freqmeas,Vgmeas5,Vomeas5] =
%   importfile_problem5('ELEN050L_Project_2_Problem_5_Measured_Results.xlsx','Sheet1',2,80);
%
%   See also XLSREAD.
